...
level_layouts = [
    ...
    [
        ...
        " LTTTTR                                                                                            LTTTTR   ",
        "          C                                                                               C                 ",
        "       LTTTTTTR       C                                                      C       LTTTTTTR               ",
        "                   LTTTTR                                                 LTTTTR                            ",
        " s                             C                                   C                                        ",
        "                            LTTTTTTTTTR                     LTTTTTTTTTR                                     ",
        "                                                                                                            "
        "                                                                                                            ",
        "                                             K    E    C                                                    ",
        "                            C       X   LTTTTTTTTTTTTTTTR             E     C     E                         ",
    ...
    [
        ...
        "                                                                                                        CIG",
        "                                                           E     C                             C       LTTT",
        "                                    C          LTTTTTTTTTTTTTTTTTTTTTTR                      LTTTTR        ",
        "                                 LTTTTTTTTR                               V        C                       ",
        "                    B      C                                                     LTTTTTTTTR      C         ",
        "                  LTTR   LTTTR                                                                LTTTTTR      ",
        "             C                                                                             C               ",
...
class Projectile(pygame.sprite.Sprite):
    def __init__(self, x, y, velocity_x):
        ...
        self.image = pygame.transform.scale(self.image, (int(30 * SCALE_X), int(20 * SCALE_Y)))  # Adjust the size as needed
